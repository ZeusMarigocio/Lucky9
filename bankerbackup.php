...
$card1banker = $_SESSION['card1'];
$card2banker = $_SESSION['card1'];


$result1 = $card1banker[$random];
$result2 = $card1banker[$random2];
...
if ($result1 == $card1[0]){
  ...
  $_SESSION['cardvalue1']= 1;

}elseif ($result1 == $card1[1]){

  $_SESSION['cardvalue1'] = 2;

}elseif ($result1 == $card1[2]){

  $_SESSION['cardvalue1'] = 3;

}elseif ($result1 == $card1[3]){

  $_SESSION['cardvalue1'] = 4;

}elseif ($result1 == $card1[4]){

  $_SESSION['cardvalue1'] = 5;

}elseif ($result1 == $card1[5]){

  $_SESSION['cardvalue1']= 6;

}elseif ($result1 == $card1[6]){

  $_SESSION['cardvalue1']= 7;

}elseif ($result1 == $card1[7]){

  $_SESSION['cardvalue1']= 8;

}elseif ($result1 == $card1[8]){

  $_SESSION['cardvalue1'] = 9;

}elseif ($result1 == $card1[9]){

  $_SESSION['cardvalue1']= 0;

}elseif ($result1 == $card1[10]){

  $_SESSION['cardvalue1'] = 1;

}elseif ($result1 == $card1[11]){

  $_SESSION['cardvalue1']= 2;

}elseif ($result1 == $card1[12]){

  $_SESSION['cardvalue1'] = 3;

}elseif ($result1 == $card1[13]){

  $_SESSION['cardvalue1']= 4;

}elseif ($result1 == $card1[14]){

  $_SESSION['cardvalue1'] = 5;

}elseif ($result1 == $card1[15]){

  $_SESSION['cardvalue1']= 6;

}elseif ($result1 == $card1[16]){

  $_SESSION['cardvalue1']= 7;

}elseif ($result1 == $card1[17]){

  $_SESSION['cardvalue1'] = 8;

}elseif ($result1 == $card1[18]){

  $_SESSION['cardvalue1'] = 9;

}elseif ($result1 == $card1[19]){

  $_SESSION['cardvalue1'] = 0;

}elseif ($result1 == $card1[20]){

  $_SESSION['cardvalue1'] = 1;

}elseif ($result1 == $card1[21]){

  $_SESSION['cardvalue1'] = 2;

}elseif ($result1 == $card1[22]){

  $_SESSION['cardvalue1'] = 3;

}elseif ($result1 == $card1[23]){

  $_SESSION['cardvalue1'] = 4;

}elseif ($result1 == $card1[24]){

  $_SESSION['cardvalue1']= 5;

}elseif ($result1 == $card1[25]){

  $_SESSION['cardvalue1'] = 6;

}elseif ($result1 == $card1[26]){

  $_SESSION['cardvalue1'] = 7;

}elseif ($result1 == $card1[27]){

  $_SESSION['cardvalue1']= 8;

}elseif ($result1 == $card1[28]){

  $_SESSION['cardvalue1'] = 9;

}elseif ($result1 == $card1[29]){
...
}elseif ($result1 == $card1[31]){

  $_SESSION['cardvalue1'] = 2;

}elseif ($result1 == $card1[32]){

  $_SESSION['cardvalue1']= 3;

}elseif ($result1 == $card1[33]){

  $_SESSION['cardvalue1'] = 4;

}elseif ($result1 == $card1[34]){

  $_SESSION['cardvalue1'] = 5;

}elseif ($result1 == $card1[35]){

  $_SESSION['cardvalue1'] = 6;

}elseif ($result1 == $card1[36]){

  $_SESSION['cardvalue1'] = 7;

}elseif ($result1 == $card1[37]){

  $_SESSION['cardvalue1']= 8;

}elseif ($result1 == $card1[38]){

  $_SESSION['cardvalue1'] = 9;

}elseif ($result1 == $card1[39]){
...
if ($result2 == $card1[0]){
  ...
  $_SESSION['cardvalue2'] = 1;

}elseif ($result2 == $card1[1]){

  $_SESSION['cardvalue2']  = 2;

}elseif ($result2 == $card1[2]){

  $_SESSION['cardvalue2'] = 3;

}elseif ($result2 == $card1[3]){

  $_SESSION['cardvalue2'] = 4;

}elseif ($result2 == $card1[4]){

  $_SESSION['cardvalue2'] = 5;

}elseif ($result2 == $card1[5]){

  $_SESSION['cardvalue2']  = 6;

}elseif ($result2 == $card1[6]){

  $_SESSION['cardvalue2']  = 7;

}elseif ($result2 == $card1[7]){

  $_SESSION['cardvalue2']  = 8;

}elseif ($result2 == $card1[8]){

  $_SESSION['cardvalue2'] = 9;

}elseif ($result2 == $card1[9]){

  $_SESSION['cardvalue2'] = 0;

}elseif ($result2 == $card1[10]){

  $_SESSION['cardvalue2'] = 1;

}elseif ($result2 == $card1[11]){

  $_SESSION['cardvalue2']  = 2;

}elseif ($result2 == $card1[12]){

  $_SESSION['cardvalue2'] = 3;

}elseif ($result2 == $card1[13]){

  $_SESSION['cardvalue2'] = 4;

}elseif ($result2 == $card1[14]){

  $_SESSION['cardvalue2']  = 5;

}elseif ($result2 == $card1[15]){

  $_SESSION['cardvalue2']  = 6;

}elseif ($result2 == $card1[16]){

  $_SESSION['cardvalue2'] = 7;

}elseif ($result2 == $card1[17]){

  $_SESSION['cardvalue2']  = 8;

}elseif ($result2 == $card1[18]){

  $_SESSION['cardvalue2'] = 9;

}elseif ($result2 == $card1[19]){

  $_SESSION['cardvalue2']  = 0;

}elseif ($result2 == $card1[20]){

  $_SESSION['cardvalue2'] = 1;

}elseif ($result2 == $card1[21]){

  $_SESSION['cardvalue2']  = 2;

}elseif ($result2 == $card1[22]){

  $_SESSION['cardvalue2']  = 3;

}elseif ($result2 == $card1[23]){

  $_SESSION['cardvalue2'] = 4;

}elseif ($result2 == $card1[24]){

  $_SESSION['cardvalue2']  = 5;

}elseif ($result2 == $card1[25]){

  $_SESSION['cardvalue2'] = 6;

}elseif ($result2 == $card1[26]){

  $_SESSION['cardvalue2'] = 7;

}elseif ($result2 == $card1[27]){

  $_SESSION['cardvalue2']  = 8;

}elseif ($result2 == $card1[28]){

  $_SESSION['cardvalue2'] = 9;

}elseif ($result2 == $card1[29]){
...
}elseif ($result2 == $card1[31]){

  $_SESSION['cardvalue2'] = 2;

}elseif ($result2 == $card1[32]){

  $_SESSION['cardvalue2'] = 3;

}elseif ($result2 == $card1[33]){

  $_SESSION['cardvalue2']  = 4;

}elseif ($result2 == $card1[34]){

  $_SESSION['cardvalue2']  = 5;
  
}elseif ($result2 == $card1[35]){

  $_SESSION['cardvalue2'] = 6;

}elseif ($result2 == $card1[36]){

  $_SESSION['cardvalue2'] = 7;

}elseif ($result2 == $card1[37]){

  $_SESSION['cardvalue2']  = 8;

}elseif ($result2 == $card1[38]){

  $_SESSION['cardvalue2']  = 9;

}elseif ($result2 == $card1[39]){

  $_SESSION['cardvalue2']  = 0;

}
$_SESSION['score1'] = $_SESSION['cardvalue1'] + $_SESSION['cardvalue2'];
if ($_SESSION['score1']>9){
  $_SESSION['finalscore'] = $_SESSION['score1']-10;
}else{
  $_SESSION['finalscore'] = $_SESSION['score1'];
}
